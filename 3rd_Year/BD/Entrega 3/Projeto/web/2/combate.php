<html>
    ...
    <body>
        ...
        if(isset($_REQUEST['n'])){
            ...
            {
                $type = $e->getCode();
                if($type == 23505) echo("<div class='centered'><h6>ERRO: Meio existe e já é de combate</h6></div>");
                else if($type == 23503){
                    try{
                        $name  = $_REQUEST['nome'];
        ...
        <div class="container">
            <table class="table col-md-8">
                ...
                foreach($result as $row)
                {
                    ...
                    echo("<td style='text-align:center'>");
                    echo("<a href='editCombate.php?num={$row['nummeio']}&nome={$row['nomemeio']}&entidade={$row['nomeentidade']}'><img width='20' src='https://goo.gl/9tGAh8'></a>");
                    echo("</td>");
                    echo("</td>");
                    echo("<td style='text-align:center'>");
