<html>
    ...
    <body>
        ...
        <div class="leftie">
            <a href="apoio.php"><button type="button" class="btn btn-primary">Back</button></a>
        </div>

        <div class="centered">
            <h2>Editar Meio de Apoio:</h2>
            <form action='editApoio.php?num=<?php echo($_REQUEST['num'])?>&entidade=<?php echo($_REQUEST['entidade'])?>' method='post'>
