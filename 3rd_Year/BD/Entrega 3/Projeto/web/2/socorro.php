    ...
    <body>
        ...
        if(isset($_REQUEST['n'])){
            ...
            {           
                ...
                $sql = "INSERT INTO meiosocorro (nummeio,nomeentidade) VALUES (:num,:entidade);";
            ...
            {
                $type = $e->getCode();
                if($type == 23505) echo("<div class='centered'><h6>ERRO: Meio existe e já é de socorro</h6></div>");
                else if($type == 23503){
                    try{
                        $name  = $_REQUEST['nome'];
